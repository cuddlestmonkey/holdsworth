...
#ifndef HOLDSWORTH_HANDMODEL_H
#define HOLDSWORTH_HANDMODEL_H
...
/*!
 * \brief Base class for a model of the capabilities of the left hand (note span etc.)
 *
 */
class HandModel
{
