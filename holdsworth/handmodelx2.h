...
#ifndef HOLDSWORTH_HANDMODELX2_H
#define HOLDSWORTH_HANDMODELX2_H
 ...
 * allows first-finger and fourth finger extensions. Referred to in MIGT
 * as "double extension".
 *
 */
class HandModelX2 : public HandModel
{
public:
    HandModelX2();
    virtual ~HandModelX2() {/*empty*/}
    ...
    virtual int cost(const Fingering&, FingerPosition);
};

}
#endif /* HOLDSWORTH_HANDMODELX2_H */
